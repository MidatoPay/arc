...
const translations = {
  en: {
    ...
    charge: {
      ...
      cta: "Collect",
      working: "Collecting…",
      workingHint: "Simulating ARS payment and sending USDC from the treasury",
    ...
    convert: {
      ...
      working: "Converting…",
      workingHint: "Quoting and confirming the transfer on Arc",
    ...
    success: {
      ...
      arsCredited: (ars) => `Simulated ARS balance credited: $${ars}`,
  ...
  es: {
    ...
    charge: {
      ...
      cta: "Cobrar",
      working: "Cobrando…",
      workingHint: "Simulando el pago en ARS y enviando USDC desde la recaudadora",
    ...
    convert: {
      ...
      workingHint: "Cotizando y confirmando la transferencia en Arc",
      treasuryLabel: "Recaudadora",
    },
    gas: {
    ...
    success: {
      ...
      arsCredited: (ars) => `Saldo ARS simulado acreditado: $${ars}`,
